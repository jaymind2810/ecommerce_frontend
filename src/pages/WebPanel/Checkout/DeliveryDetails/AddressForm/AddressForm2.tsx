...
export default function NewAddressForm() {
  return (
    <form className="bg-white border-gray-200 container justify-center max-w-[608px] p-6 rounded-lg right-4 rounded-lg ring-1 ring-black ring-opacity-5 shadow-lg">
      <div className="space-y-12">
        ...
        <div className="flex gap-x-4 items-center justify-end mt-6 pb-6">
          <button 
            type="button" 
